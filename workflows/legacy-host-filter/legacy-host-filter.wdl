...
workflow czid_host_filter {
  input {
    ...
    File star_genome
    File bowtie2_genome
    File gsnap_genome = "s3://seqtoid-public-references/host_filter/human/2018-02-15-utc-1518652800-unixtime__2018-02-15-utc-1518652800-unixtime/hg38_pantro5_k16.tar"
