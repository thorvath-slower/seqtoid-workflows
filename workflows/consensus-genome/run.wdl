...
workflow consensus_genome {
    ...
    input {
        ...
        File ercc_fasta = "s3://seqtoid-public-references/consensus-genome/ercc_sequences.fasta"
        File kraken2_db_tar_gz  # TODO: make this optional; only required if filter_reads == true, even for Illumina
        File primer_bed = "s3://seqtoid-public-references/consensus-genome/artic_v3_primers.bed" # Only required for Illumina
        ...
        # ONT-specific inputs
        File primer_schemes = "s3://seqtoid-public-references/consensus-genome/artic-primer-schemes_v2.tar.gz"
        ...
        File vadr_model = "s3://seqtoid-public-references/consensus-genome/vadr-models-sarscov2-1.2-2.tar.gz"
        ...
        Int   minDepth          = if "~{primer_bed}" == "s3://seqtoid-public-references/consensus-genome/na_primers.bed" then 5 else 10
